...
public:
  ...
  ~TerrainTileBvh();
  /// Rebase exact metadata as needed; return true only when hardware BVHs rebuild.
  bool
  ...
  /// Observer displacement from the hardware catalogue's fixed curvature frame.
  Coord observer_offset() const;
